...
//        $foto->setIdfoto($Foto_idfoto);
        ...
        ProductoFacade::insertProductoAdmin($nombreProducto, $cantidadProductoInventario, $precioUnitarioProducto, $descripcionProducto, $calidadTipo,  $ubicacionProducto, $categoria);
echo true;
