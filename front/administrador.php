        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        <a onclick="Usuario_Listar()"><i class="fa fa-group" style="color: #fff"></i> <span class="nav-label" style="color: #fff">Clientes</span></a>
                    </li>
                    <li>
                        <a onclick="Producto_ListarAdmin()"><i class="fa fa-cubes" style="color: #fff"></i> <span class="nav-label" style="color: #fff">Productos</span></a>
                    </li>

                    <li>
                        <a onclick="Producto_RegistrarAdmin()"><i class="fa fa-cubes" style="color: #fff"></i> <span class="nav-label" style="color: #fff">Datos Personales</span></a>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse">
                            <li><a onclick="ProductoInsert">Reporte Productos Ofertados</a></li>
                            <li><a onclick="">Reporte Vendidos</a></li>
                            <li><a onclick="">Reporte de Clientes</a></li>
